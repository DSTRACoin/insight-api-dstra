...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.insight-dstra');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\DSTRA2\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/DSTRA2/';
  if (isLinux) dataDir = process.env.HOME + '/.dstra2/';
}
